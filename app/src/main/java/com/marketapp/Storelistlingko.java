...
public class Storelistlingko extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_storelistlingko);

        recyclerView = findViewById(R.id.Storelistlingko);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(Storelistlingko.this,1);
        ...
        nameMarket = "Lingko"; // ตรงที่พี่น้ำเพิ่มมา
        ...
        checkData.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    Toast.makeText(Storelistlingko.this, "ไม่พบข้อมูล", Toast.LENGTH_SHORT).show();
